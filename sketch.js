...
function setup(){
  ...
  yoga.elt.width = windowWidth/2;
  yoga.elt.height = windowWidth/2 - 350;
  yoga.position(0, 160);
  ...
  doctor.elt.width = windowWidth/2;
  ...
  cnslng.elt.height = windowWidth/2 - 300;
  ...
  helpline.elt.width = windowWidth/2;
  ...
  travel.elt.width = windowWidth/2;
  ...
  shopping.elt.width = windowWidth/2;
  ...
  weatherIcon.position(windowWidth/4 - 100,10);
  ...
  boxDiv.position(windowWidth/2 - 150, 100);
  ...
  weatherSelector.position(windowWidth/2 - 60,250);
  ...
  horoscopeSelector.position(windowWidth/2 - 60,230);
  ...
  citySelector.position(windowWidth/2 - 80,250);
  citySelector.hide();
  ...
  jokeText.position(windowWidth/2 - 120,220);
  ...
  table.style = "left:" + (windowWidth/4 - 70) + "px; top:500px; display:none";
}
...
function draw(){
  ...
  hideButton.mousePressed(()=>{
    ...
    boxDiv.hide();
    hideButton.hide();
    table.style = "left:" + windowWidth/4 + "px; top:450px; display:none";
    boxDiv.style("width","300px");
  })

  weatherIcon.mousePressed(()=>{
    if(clicked===false){
      boxDiv.position(windowWidth/2 - 150, 200);
  ...
  horoscopeIcon.mousePressed(()=>{
    if(clicked===false){
      boxDiv.position(windowWidth/2 - 400, 200);
      boxDiv.style("height","300px");
  ...
  hospitalIcon.mousePressed(()=>{
    if(clicked===false){
      boxDiv.position(windowWidth/2 - 300, 200);
  ...
  doctor.mousePressed(()=>{
    if(clicked===false){
      boxDiv.position(windowWidth/2 - 175, 200);
  ...
  cnslng.mousePressed(()=>{
    if(clicked===false){
      boxDiv.position(windowWidth/2 - 150, 500);
  ...
  helpline.mousePressed(()=>{
    if(clicked===false){
      boxDiv.position(windowWidth/4 - 90, 450);
      boxDiv.style("width","850px");
      boxDiv.style("height","650px");
      table.style = "left:" + (windowWidth/4 - 70) + "px; top:500px; display:block";
  ...
  movie.mousePressed(()=>{
    if(clicked===false){
      boxDiv.position(windowWidth/2 - 150, 800);
  ...
  travel.mousePressed(()=>{
    if(clicked===false){
      boxDiv.position(windowWidth/2 - 250, 800);
      boxDiv.style("height","300px");
  ...
  shopping.mousePressed(()=>{
    if(clicked===false){
      boxDiv.position(windowWidth/2 - 150, 1270);
...
function createButtons(){
  ...
  yogaSelector1.position(windowWidth/2 - 100, 250);
  ...
  doctorSelector1.position(windowWidth/2 - 135, 250);
  ...
  cnslngSelector1.position(windowWidth/2 - 125, 530);
  ...
  movieSelector1.position(windowWidth/2 - 100, 850);
  ...
  travelSelector1.position(windowWidth/2 - 225, 900);
  ...
  hotelSelector1.position(windowWidth/2 + 25, 900);
  ...
  shoppingSelector1.position(windowWidth/2 - 135, 1300);
  ...
  gameSelector1.position(windowWidth/2 - 135, 1300);
